...
const Chef = () => {
  ...
  return (
    <div ref={ref} className="app__bg app__wrapper section__padding">
      ...
      >
        <motion.h1 className="head__text" variants={chefItemVariants}>What we believe in</motion.h1>
        ...
        <motion.div className="app__chef-content" variants={chefContentVariants}>
          <motion.div className="app__chef-content_quote" variants={chefItemVariants}>
            ...
            <p className="p__opensans">
              My passion is transforming familiar local ingredients into gastronomic discoveries. In our restaurant, we blend time-honored traditions           </p>
            <img
